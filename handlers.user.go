...
func performLogin(c *gin.Context) {
	//Obtain the POSTed username and password valeus
...
func generateSessionToken() string {
	...
	//This is not a secure key of generating session tokens
...
func register(c *gin.Context) {
	...
	if _, err := registerNewUser(username, password); err == nil {
		...
		//If the username/password combination is invalid show the error messsage on the login page
